...
\par \textbf{FBLA:}
\begin{details}
    \item Finished 7th nationally in Future Business Leaders of America's \textit{Desktop Application Programming} category in 2011 (C++)
\end{details}

\par \textbf{Aviation:}
\begin{details}
    \item I obtained my Private Pilot Certificate on July 3 2014 and have accumulated more than 150 flying hours.~
...
\begin{details}
    \item I have been learning the German language since 2008, and am conversationally fluent.
\end{details}
