...
\begin{details}
    \item Develop Python ETL and Java backend for weather reporting website
    \vspace{.5em}
    \begin{details}
        \item Website was built by Maven and ran on Apache Tomcat on an Ubuntu server
    \end{details}
\end{details}

\employer{Extreme Engineering Solutions}{Associate Embedded Engineer (Internship)}{January 2016 to July 2016}
\begin{details}
    \item Build, test, and release IPMI firmware (in C) for VPX computers
...
\begin{details}
    ...
    \item Create quiz-generating and scoring software for course website (in PHP/SQL)
\end{details}
...
\begin{details}
    ...
    \item Work closely with marketing team to create web content and keep website up to date with events and news
\end{details}
